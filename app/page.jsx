...
export default function Home() {
  return (
    <>
      ...
      <Script id="3dfloor-legacy-loader" strategy="afterInteractive">{`
        (function () {
          if (window.__3dfloor_loaded) return;
          window.__3dfloor_loaded = true;
          ...
          scripts.reduce(function (p, src) {
            ...
            console.error('[3dfloor] Script load error:', err);
          });
        })();
      `}</Script>
    </>
